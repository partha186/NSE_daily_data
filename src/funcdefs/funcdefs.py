...
if __name__ != "__main__":
    ...
    DAILY_FOLDER = DIR / "NSE_eod_data" / "daily"
    ISIN_FILE = DIR / "NSE_eod_data" / "isin.csv"
    AMIBROKER_FOLDER = DIR / "NSE_eod_data" / "amibroker"
    META_FILE = DIR / "NSE_eod_data" / "meta.json"
    SPECIAL_SESSIONS_FILE = DIR / "NSE_eod_data/special_sessions.txt"
